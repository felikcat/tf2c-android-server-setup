...
. To get all the required system dependencies for hosting a TF2C Android server, https://developer.valvesoftware.com/wiki/SteamCMD#Linux[install SteamCMD on the server].
